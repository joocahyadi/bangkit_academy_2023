...
def solution_C4():
    ...
    # Fit the tokenizer into the training sentences
    ...
    train_sequences = pad_sequences(x_train, maxlen=max_length, padding=padding_type, truncating=trunc_type)
    test_sequences = pad_sequences(x_test, maxlen=max_length, padding=padding_type, truncating=trunc_type)
