...
def solution_A4():
    ...
    # Convert the sentences into sequences of numbers (tokenizing the sentences)
    ...
    # Pad the tokenized training and testing sentences
    ...
    # Train the model
    model.fit(x=padded_training_sentences, y=training_labels, epochs=3,
